...
if __name__ == "__main__":
    ...
    requests = [{"trial" : f"{i}_{j}",
                ...
                "algroithmID" : f"Basic\{Dataset}_para4_Basic",
                "parallelCores" : "6",
                "experimentID" : f"trial{i}{j}_art30_nodensity",
                "trainFile" : f"dataset_nodes/{Dataset}/minCIM_30/a{i}_{j}_{Dataset}_nodes_ART.csv",
